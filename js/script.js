...
'               /*modified code start*/ display: table-row; /*modified code end*/',
'           }',
'',
...
window.onload = function() {
    ...
    appender.addEventListener('load', function() {
        ...
        consoleWin.LogEntryMainElementContainer = function(logEntry, containerDomNode) {
            ...
            var customClass = consoleWin.logEntries.length % 2 ? 'light' : 'dark';
            this.mainDiv.className = 'logentry nonielogentry ' + customClass + ' ' + logEntry.level;
